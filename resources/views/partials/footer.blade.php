<div class="bg-[#102587] py-8 sm:px-44">
      <div class="grid sm:grid-cols-5">
        <div class="sm:col-span-3">
          ...
          <p class="!text-[14px] !font-normal text-white !p-0 leading-[1.2] sm:w-[300px] !mt-5 !me-0 sm:text-start text-center ">JL. Kasang Pudak RT.14 Lorong Pesantren Kec.Kumpeh Ulu</p>
        ...
        <div class="">
          ...
          <p class="!text-[14px] !font-normal text-white leading-[1.2]">Instagram</p>
          <p class="!text-[14px] !font-normal text-white leading-[1.2]">Tiktok</p>
          <p class="!text-[14px] !font-normal text-white leading-[1.2]">WhatsApp</p>
          <div class="flex gap-4">
            <!-- Instagram -->
            <a href="#" class="!no-underline w-10 h-10 rounded-full bg-[#3E4CB3] flex items-center justify-center !text-white">
